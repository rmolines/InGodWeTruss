...
class Truss:
    ...
    def __init__(self, nodes, elements):
        ...
        self.n_fd                    = o        # Number of freedom_degrees in the Truss
    ...
    def _gen_boundaries_force_array(self):
        ...
        return force_matrix, boundaries_conditions, n_bc                  # Return all the arrays
